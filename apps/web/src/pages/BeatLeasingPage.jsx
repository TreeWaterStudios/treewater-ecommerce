          ...
          <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            <div className="text-center mb-10">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto drop-shadow-md">
                Preview tagged beats, compare lease options, and complete
                secure checkout through the official TreeWater Studios
                BeatStars player.
              </p>
            </div>
              ...
              <div className="mb-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Beat previews, lease options, checkout, and download
                    delivery are handled securely by BeatStars. © 2026
                    TreeWater Studios. All Rights Reserved.
                  </p>
                </div>
