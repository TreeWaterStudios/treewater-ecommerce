...
export default function MerchandiseStore() {
  ...
  return (
    <div className="merch-page-bg min-h-screen bg-[#0a0a0a] flex flex-col font-sans text-gray-100">
      <Helmet>
        <title>Merchandise Store - TREEWATER STUDIOS</title>
        <meta
          name="description"
          content="Shop official Treewater Studios merchandise, apparel, and accessories."
        />
      </Helmet>
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <Button
            variant="outline"
            className="w-full md:w-auto border-white/10 text-white hover:bg-white/5 rounded-xl"
          >
